...
В начале этой статьи было дано определение пакета, а сейчас требуется его расширить для более полного понимания, что это такое. Схематично структуру пакета можно изобразить на следующей схеме:
