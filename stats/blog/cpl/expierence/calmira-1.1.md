...
- Особая философия дистрибутива, гарантирующая, что в дистрибутиве содержится только свободное ПО (за исключением некоторых компонентов ядра), а так же полную свободу действий пользователей.
